...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="row">
    <div class="col-md-3">
       <br><p> Please Pick a number: <asp:TextBox ID="TextBox1" runat="server" Width="196px"></asp:TextBox></p>
        <p>            
    ...
    <div class="col-md-3">
          <asp:Label ID="Label2" runat="server" Text="Numbers Guessed:" style= "font-size:26px;font-weight:bold"  Visible="false"></asp:Label>
